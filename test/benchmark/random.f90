module random
    ...
    integer(kind=int32), parameter :: A = -1727483681_int32 ! 0x9908B0DF
    ...
    integer(kind=int32), parameter :: B = -1658038656_int32 ! 0x9D2C5680
    integer(kind=int32), parameter :: T = 15_int32
    integer(kind=int32), parameter :: C = -272236544_int32 ! 0xEFC60000
    integer(kind=int32), parameter :: L = 18_int32
    integer(kind=int32), parameter :: MASK_LOWER = huge(1_int32)
    integer(kind=int32), parameter :: MASK_UPPER = -huge(1_int32)-1
